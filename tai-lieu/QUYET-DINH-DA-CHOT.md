...
| 18.12 | **Thêm cách đăng nhập thứ hai: tài khoản email + mật khẩu** (thay quy tắc cũ "chỉ Google", đã sửa CLAUDE.md). Tạo tài khoản gồm: tên hiển thị, email, mật khẩu, nhập lại mật khẩu. Đăng nhập bằng EMAIL + mật khẩu (không dùng tên đăng nhập, vì muốn vậy phải để công khai bảng tra tên → email, lộ email người dùng) |
